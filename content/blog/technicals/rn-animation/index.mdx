...
![Animating Background in web browsers](./list-add.gif)
...
```
However, for React Native, we do not have the luxury of CSS Animations. Thus, needing to rely on our old trust `Animated`.
